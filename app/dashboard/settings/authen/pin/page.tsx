...
<h1 className="text-sm font-semi-bold text-content-day ml-3">Settings / Authentication / Pin Setting</h1>
</div>
     ...
     <div className="w-full p-6">
      <div className="bg-[#f7f8f8] flex-col flex h-[35vh] p-7 gap-12">
        <div className="w-full flex items-start justify-center flex-col gap-2">
          <p className="text-xl font-medium">PIN Setting</p>
          <p className="text-[12px]">Change pin</p>
        </div>
        <div className="flex lg:flex-row flex-col lg:items-center items-start lg:gap-20 gap-3">
          ...
          <Button className="mt-5">Change PIN</Button>
        </div>
        <div>
